...
#define CHECK_DEBUG_DATA		(d->f51.dsc.data_base + 74)
...
#define OBJECT_REPORT_ENABLE_REG	(d->f12.dsc.control_base + 9)
#define FEATURE_ENABLE_REG		(d->f12.dsc.control_base + 12)
