...
/* Should be replaced by TZBSPv4 platform common flag */
 ...
 * But for 8937, architecture is armv8 with __aarch32__ in Sw.
 */
#define MC_ARMV7_FC
#else
#define MC_AARCH32_FC
#endif /* not CONFIG_ARCH_MSM8937 */
